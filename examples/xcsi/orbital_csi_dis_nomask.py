...
def calculate_ext_csi(fullerene: FullereneFamily, para=7, distance_cutoff=None):
    ...
    sum_chi = np.linalg.eigh(extend_adj)
...
if __name__ == '__main__':
    ...
    CSI_NPY_STORE_PREFIX = r"D:\CODE\#DATASETS\FullDB\c2addonwork\xCSI_dis_nomask"  # change this
    ...
    CSI_NPY_FILE_SUFFIX = "xCSI_dis_nomask"
    _ = \
        """
    # =============== PART 2 ================ #
    2. Calculate if needed.
