...
if __name__ == '__main__':
    ...
    for N in draw_list:
        ...
        enref = np.load((pathlib.Path(
            r"C:\Users\45990\Nutstore\1\我的坚果云\draft\2022\xCSI\data\xCSI7_noangle") / f"C{N}_xCSI_noangle.npz").as_posix())[
        ...
        for charge in charged_list:
            ...
            file = (pathlib.Path(
                r"C:\Users\45990\Nutstore\1\我的坚果云\draft\2022\xCSI\data\xCSI7_noangle" + charge_in_name) / f"C{N}_xCSI_noangle.npz").as_posix()
            file = np.load(file)
            ...
            if True:
                if charge == 0:
                    ...
                    ax.set_xlabel(r"$E^\mathrm{noangle}_\mathrm{XCSI}$")
                    ax.set_ylabel(
                ...
                img = mpimg.imread("xcsinoangle.png")
                ax.set_axis_off()
                ax.imshow(img,)
            with open(rf"C:\Users\45990\Nutstore\1\我的坚果云\draft\2022\xCSI\figures_draft\XCSInoangle\Pearson.txt","a") as f:
                ...
                print(f"{N} "
                      ...
                      file=f)
        plt.savefig(
            rf"C:\Users\45990\Nutstore\1\我的坚果云\draft\2022\xCSI\figures_draft\XCSInoangle\C{N}_xCSI_noangle.png",
            dpi=600)
        # if N == 60:
        #     ax = fig.add_subplot(spec[0, 1])
