...
if __name__ == '__main__':
    ...
    for N in draw_list:
        ...
        enref = np.load((pathlib.Path(
            r"C:\Users\45990\Nutstore\1\我的坚果云\draft\2022\xCSI\data\xCSI_dis_angle") / f"C{N}_xCSI_dis_angle.npz").as_posix())[
        ...
        for charge in charged_list:
            ...
            file = (pathlib.Path(
                r"C:\Users\45990\Nutstore\1\我的坚果云\draft\2022\xCSI\data\xCSI_dis_angle" + charge_in_name) / f"C{N}_xCSI_dis_angle.npz").as_posix()
            file = np.load(file)
            ...
            if True:
                if charge == 0:
                    ...
                    ax.set_xlabel(r"$E^\mathrm{angle,dis}_\mathrm{XCSI}$", size=15)
                    ax.set_ylabel(
                ...
                ax.set_axis_off()
                ax.imshow(img, )
            with open(rf"C:\Users\45990\Nutstore\1\我的坚果云\draft\2022\xCSI\figures_draft\XCSIangledis\Pearson.txt","a") as f:
                ...
                print(f"{N} "
                      ...
                      file=f)
        plt.savefig(
            rf"C:\Users\45990\Nutstore\1\我的坚果云\draft\2022\xCSI\figures_draft\XCSIangledis\C{N}_XCSI.png",
            dpi=600)
        # if N == 60:
        #     ax = fig.add_subplot(spec[0, 1])
